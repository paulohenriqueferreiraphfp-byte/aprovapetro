    ...
    <div className="h-screen bg-[#121214] text-white flex flex-col">
      ...
      <main className="flex-1 overflow-auto p-8 flex justify-center">
        <div className="max-w-3xl w-full">
          ...
          <p className="text-xl mb-8 leading-relaxed whitespace-pre-wrap text-white font-medium">{currentQ.statement || 'Erro: Enunciado não encontrado no banco de dados.'}</p>
