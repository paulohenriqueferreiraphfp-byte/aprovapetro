  ...
  const cesgranrioQuestions = [
    ...
    },
    {
      ...
      options: [
        ...
        'D) A partir de amanhã, o acesso será restrito à diretoria.', // Wait, "a partir" does not have crase, so D is the one that is correct if it didn't have crase. Let me fix the option D to make it INCORRECT with crase.
        // Actually, let's make D incorrect.
        'E) Chegamos às duas horas da tarde.'
      ]
    }
  ];
  
  // Fix the crase question (index 7)
